...
<header class="border-b border-gray-800">
    <nav class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4 py-3">
        ...
        <div class="flex items-center mt-6 lg:mt-0">
            ...
            <div class="ml-6">
                <a href=""><img
                        src="https://lh3.googleusercontent.com/ogw/ADGmqu_HqHHv95kQQ-RBR2tJBCbvn1c70RMriQjheOKLtA=s32-c-mo"
                        class="rounded-full w-8" alt=""></a></div>
        </div>
